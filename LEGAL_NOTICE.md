...
*   **No Legal Advice:** We do not provide legal advice regarding copyright compliance.

## AI/ML Disclosure
*   **Cloud Processing:** OCR, translation, summarization, and TTS features may use third-party cloud AI services (e.g., Google Gemini).
*   **User-Initiated:** Processing only occurs when you explicitly request it.
*   **No Training:** Your User Content is **not** used by LexaVox to train AI models.
*   **Transient:** Cloud processing is transient; content is not retained by LexaVox beyond the duration of the requested task.

...
*   **Access Control:** Access to cloud APIs (OCR, Translation, TTS) is secured via server-configured credentials that are not exposed in the client app code where possible.

## User Responsibility
*   **Device Security:** You are responsible for securing your device with a passcode, biometrics, or other security measures to prevent unauthorized access to your stored history.
...
*   **No Unauthorized Access:** We do not access your User Content unless explicitly initiated by you for processing.
